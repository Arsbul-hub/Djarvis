...
from app.speech import SpeechManager
...
class CommandManager:
    ...
    def __init__(self):
        ...
        def walk(c_list):
            ...
            for c in c_list:
                ...
                script_execute = (lambda s=script, a=args: self.scripts_manager.execute(s, a)) if script else None
    ...
    def say_error(self, error_code):
        self.scripts_manager.execute_error(error_code)
